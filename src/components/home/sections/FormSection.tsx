  ...
  return (
    <section className="w-full bg-white py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-[1330px] px-6 md:px-8">
        <div className="grid gap-12 md:grid-cols-7 md:gap-12 lg:gap-12">
          {/* Left Contenat */}
          <motion.div
          ...
          >
            ...
            <div className="mb-8 lg:mb-12">
              <h2 className="mb-4 text-[36px] font-bold leading-tight text-black md:text-[42px] lg:text-[48px]">
                Ready to Transform
                <br />
                Your Practice?
              </h2>
            ...
            <div className="space-y-6 lg:space-y-8">
              {features.map((feature, index) => (
                ...
                >
                  <h3 className="mb-2 text-[20px] font-medium text-black md:text-[22px] lg:text-[24px]">
                    {feature.title}
                  </h3>
                  <p className="text-[18px] font-medium text-[#666666] md:text-[20px] lg:text-[22px]">
                    {feature.description}
          ...
          >
            <div className="w-full rounded-3xl bg-white p-11 shadow-lg py-[80px] ">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-center">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="rounded-full bg-[#473BF0] px-12 py-4 text-[18px] font-medium text-white transition-colors hover:bg-[#3730d8] md:text-[19px] lg:text-[20px]"
                  >
